...
.controller("VentanillasFormCtrl", VentanillasFormCtrl);
 function VentanillasFormCtrl($scope, $meteor, $reactive, $state, toastr, $stateParams){
  ...
  this.guardar = function(objeto,form)
	{
			...
			Meteor.call('createUsuario', objeto, "Ventanilla");
