...
.controller("PromotorasFormCtrl", PromotorasFormCtrl);
 function PromotorasFormCtrl($scope, $meteor, $reactive, $state, toastr, $stateParams){
  ...
  this.subscribe('ciudades',()=>{
	...
	this.guardar = function(objeto,form)
	{
			...
			Meteor.call('createUsuario', objeto, "Promotora");
...
*/		
			...
			Meteor.call('updateUsuario', objeto,null, "Promotora", this.cambiarContrasena);
