...
*/
  ...
  this.actualizarForm = function (objeto, form) {
    ...
    loading(true);
    Meteor.call('actualizarProspectosCreditosPersonalesDistribuidores', objeto, this.referenciasPersonales, "Distribuidor", function (error, result) {
    ...
    //Quitar el modelo la subcripcion ruta de este de abajo
