angular
  .module('creditoMio')
  .controller('SolicitudDistribuidorFormCtrl', SolicitudDistribuidorFormCtrl);

function SolicitudDistribuidorFormCtrl($scope, $meteor, $reactive, $state, toastr, $stateParams) {
  ...
  rc.objeto.profile.cuentaConAuto = "no";
  ...
  this.guardar = function (objeto, form) {
    ...
    objeto.profile.estatus = 2; //1.- Sin Asignar , 2.- Asignado a una sucursal
    ...
    Meteor.call('guardarSolicitudDistribuidor', objeto, function (e, r) {
      if (r) {
  ...
  this.actualizar = function (objeto, form) {
    ...
    Meteor.call('actualizarSolicitudDistribuidor', objeto, function (e, r) {
      if (r) {
