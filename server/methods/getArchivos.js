Meteor.methods({
	...
	getFichaProspectoCreditoPersonal: function (objeto, referencia, tipo) {

		objeto.numeroCliente = "------"
		...
		objeto.referencias = [];
		_.each(referencia, function (rp) {

			var referencia = {};

			referencia.nombreCompleto = rp.nombreCompleto;
			referencia.direccion = rp.direccion;
			referencia.telefono = rp.telefono;
			referencia.tiempo = rp.tiempoConocerlo;
		...
		objeto.sucursal = Sucursales.findOne(objeto.sucursal_id).nombreSucursal;
		...
		objeto.estadoCivil = EstadoCivil.findOne(objeto.estadoCivil_id).nombre;
		objeto.ocupacion = Ocupaciones.findOne(objeto.ocupacion_id).nombre;
		objeto.cp = objeto.codigoPostal;
		objeto.telefonoMovilContacto = objeto.celular;
		objeto.telefonoContacto = objeto.particular;
		objeto.empresaC = Empresas.findOne(objeto.empresa_id);
	...
	getFichaProspectoDistribuidor: function (objeto, referencia, tipo) {
